...
pub use xcm::{
	prelude::*,
	v3::{Error, NetworkId::Rococo as RococoId, NetworkId::Wococo as WococoId},
	DoubleEncoded,
};
...
pub use integration_tests_common::{
	...
	BridgeHubRococo, BridgeHubRococoPallet, BridgeHubRococoReceiver, BridgeHubRococoSender,
	BridgeHubWococo, BridgeHubWococoPallet, BridgeHubWococoReceiver, BridgeHubWococoSender,
	AssetHubWococo, AssetHubWococoPallet, AssetHubWococoReceiver, AssetHubWococoSender,
	Collectives, CollectivesPallet, CollectivesReceiver, CollectivesSender, Rococo, RococoMockNet,
	RococoPallet, RococoReceiver, RococoSender, PenpalRococoA, PenpalRococoAReceiver,
	PenpalRococoASender, Wococo, WococoMockNet, WococoPallet, WococoReceiver, WococoSender, PenpalRococoAPallet,
};
...
pub fn mint_asset(
	...
	AssetHubRococo::execute_with(|| {
		assert_ok!(
			<AssetHubRococo as AssetHubRococoPallet>::Assets::mint(
				signed_origin,
				id.into(),
...
pub fn force_create_and_mint_asset(
	...
	let signed_origin = <AssetHubRococo as Chain>::RuntimeOrigin::signed(
		asset_owner.clone()
	);
