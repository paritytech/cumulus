...
pub use integration_tests_common::{
	...
	AssetHubWestendPallet, AssetHubWestendReceiver, AssetHubWestendSender, CollectivesPolkadot,
	CollectivesPolkadotPallet, CollectivesPolkadotReceiver, CollectivesPolkadotSender,
	CollectivesWestend, CollectivesWestendPallet, CollectivesWestendReceiver, CollectivesWestendSender,
	PenpalWestendA,
