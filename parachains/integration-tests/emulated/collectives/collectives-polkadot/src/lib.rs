...
pub use integration_tests_common::{
	...
	BridgeHubPolkadotPallet, BridgeHubPolkadotReceiver, BridgeHubPolkadotSender, CollectivesPolkadot,
	CollectivesPolkadotPallet, CollectivesPolkadotReceiver, CollectivesPolkadotSender, PenpalPolkadotA,
