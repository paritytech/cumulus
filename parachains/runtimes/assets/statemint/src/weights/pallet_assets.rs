...
impl<T: frame_system::Config> pallet_assets::WeightInfo for WeightInfo<T> {
	...
	fn destroy(c: u32, s: u32, a: u32, ) -> Weight {
		Weight::from_ref_time(0 as RefTimeWeight)
			...
			.saturating_add((15_904_000 as RefTimeWeight).saturating_mul(c as Weight))
			// Standard Error: 45_000
			.saturating_add((18_803_000 as RefTimeWeight).saturating_mul(s as Weight))
			// Standard Error: 450_000
			.saturating_add((17_017_000 as RefTimeWeight).saturating_mul(a as Weight))
			.saturating_add(T::DbWeight::get().reads(5 as RefTimeWeight))
			.saturating_add(T::DbWeight::get().reads((2 as RefTimeWeight).saturating_mul(c as Weight)))
			.saturating_add(T::DbWeight::get().reads((2 as RefTimeWeight).saturating_mul(s as Weight)))
			.saturating_add(T::DbWeight::get().reads((1 as RefTimeWeight).saturating_mul(a as Weight)))
			.saturating_add(T::DbWeight::get().writes(2 as RefTimeWeight))
			.saturating_add(T::DbWeight::get().writes((2 as RefTimeWeight).saturating_mul(c as Weight)))
			.saturating_add(T::DbWeight::get().writes((2 as RefTimeWeight).saturating_mul(s as Weight)))
			.saturating_add(T::DbWeight::get().writes((1 as RefTimeWeight).saturating_mul(a as Weight)))
	}
	// Storage: Assets Asset (r:1 w:1)
	...
	fn set_metadata(n: u32, s: u32, ) -> Weight {
		Weight::from_ref_time(31_324_000 as RefTimeWeight)
			// Standard Error: 0
			.saturating_add((1_000 as RefTimeWeight).saturating_mul(n as Weight))
			// Standard Error: 0
			.saturating_add((3_000 as RefTimeWeight).saturating_mul(s as Weight))
			.saturating_add(T::DbWeight::get().reads(2 as RefTimeWeight))
			.saturating_add(T::DbWeight::get().writes(1 as RefTimeWeight))
	}
	// Storage: Assets Asset (r:1 w:0)
	...
	fn force_set_metadata(_n: u32, s: u32, ) -> Weight {
		Weight::from_ref_time(18_756_000 as RefTimeWeight)
			// Standard Error: 0
			.saturating_add((2_000 as RefTimeWeight).saturating_mul(s as Weight))
			.saturating_add(T::DbWeight::get().reads(2 as RefTimeWeight))
			.saturating_add(T::DbWeight::get().writes(1 as RefTimeWeight))
	}
	// Storage: Assets Asset (r:1 w:0)
