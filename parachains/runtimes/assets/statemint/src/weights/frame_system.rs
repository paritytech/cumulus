...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn remark(b: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 1_659 nanoseconds.
		Weight::from_ref_time(5_679_796)
	...
	fn remark_with_event(b: u32, ) -> Weight {
		...
		Weight::from_ref_time(10_635_000)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 0
	...
	fn set_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(3_137_000)
			...
			.saturating_add(Weight::from_ref_time(557_791).saturating_mul(i.into()))
	...
	fn kill_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(3_162_000)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 796
			.saturating_add(Weight::from_ref_time(425_658).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
	}
	/// Storage: Skipped Metadata (r:0 w:0)
	/// Proof Skipped: Skipped Metadata (max_values: None, max_size: None, mode: Measured)
	...
	fn kill_prefix(p: u32, ) -> Weight {
		...
		Weight::from_ref_time(3_743_000)
			...
			.saturating_add(Weight::from_ref_time(977_725).saturating_mul(p.into()))
