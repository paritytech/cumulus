...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn set_storage(i: u32, ) -> Weight {
		Weight::from_ref_time(0 as RefTimeWeight)
			...
			.saturating_add((626_000 as RefTimeWeight).saturating_mul(i as RefTimeWeight))
	...
	fn kill_storage(i: u32, ) -> Weight {
		Weight::from_ref_time(0 as RefTimeWeight)
			// Standard Error: 1_000
			.saturating_add((515_000 as RefTimeWeight).saturating_mul(i as RefTimeWeight))
			.saturating_add(T::DbWeight::get().writes((1 as RefTimeWeight).saturating_mul(i as RefTimeWeight)))
	}
	// Storage: Skipped Metadata (r:0 w:0)
	...
	fn kill_prefix(p: u32, ) -> Weight {
		Weight::from_ref_time(0 as RefTimeWeight)
			// Standard Error: 1_000
			.saturating_add((1_052_000 as RefTimeWeight).saturating_mul(p as RefTimeWeight))
