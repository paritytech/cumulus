...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		Weight::from_ref_time(30_959_000 as RefTimeWeight)
			...
			.saturating_add((3_220_000 as RefTimeWeight).saturating_mul(c as Weight))
	}
	...
	fn batch_all(c: u32, ) -> Weight {
		Weight::from_ref_time(16_465_000 as RefTimeWeight)
			...
			.saturating_add((3_364_000 as RefTimeWeight).saturating_mul(c as Weight))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		Weight::from_ref_time(22_621_000 as RefTimeWeight)
			...
			.saturating_add((3_147_000 as RefTimeWeight).saturating_mul(c as Weight))
	}
}
