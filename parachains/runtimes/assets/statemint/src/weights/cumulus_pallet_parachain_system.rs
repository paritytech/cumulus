...
impl<T: frame_system::Config> cumulus_pallet_parachain_system::WeightInfo for WeightInfo<T> {
	...
	fn authorize_upgrade() -> Weight {
		Weight::from_ref_time(18_804_000 as u64)
	...
	fn sudo_send_upward_message(l: u32, ) -> Weight {
		Weight::from_ref_time(11_803_000 as u64)
			// Standard Error: 1_218
			.saturating_add(Weight::from_ref_time(13_621 as u64).saturating_mul(l as u64))
	...
	fn enact_authorized_upgrade(s: u32, ) -> Weight {
		Weight::from_ref_time(31_250_000 as u64)
			// Standard Error: 6
			.saturating_add(Weight::from_ref_time(1_824 as u64).saturating_mul(s as u64))
	...
	fn set_validation_data() -> Weight {
		Weight::from_ref_time(87_911_000 as u64)
