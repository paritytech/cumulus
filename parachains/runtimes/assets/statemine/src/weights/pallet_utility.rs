...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		Weight::from_ref_time(22_923_000 as RefTimeWeight)
			...
			.saturating_add((3_526_000 as RefTimeWeight).saturating_mul(c as Weight))
	}
	...
	fn batch_all(c: u32, ) -> Weight {
		Weight::from_ref_time(20_953_000 as RefTimeWeight)
			...
			.saturating_add((3_698_000 as RefTimeWeight).saturating_mul(c as Weight))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		Weight::from_ref_time(10_076_000 as RefTimeWeight)
			// Standard Error: 2_000
			.saturating_add((3_546_000 as RefTimeWeight).saturating_mul(c as Weight))
	}
}
