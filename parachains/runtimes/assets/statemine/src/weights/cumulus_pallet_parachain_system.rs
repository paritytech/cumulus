...
impl<T: frame_system::Config> cumulus_pallet_parachain_system::WeightInfo for WeightInfo<T> {
	...
	fn sudo_send_upward_message(l: u32, ) -> Weight {
		Weight::from_ref_time(11_570_000 as u64)
			// Standard Error: 918
			.saturating_add(Weight::from_ref_time(12_749 as u64).saturating_mul(l as u64))
	...
	fn enact_authorized_upgrade(s: u32, ) -> Weight {
		Weight::from_ref_time(31_306_000 as u64)
			// Standard Error: 3
			.saturating_add(Weight::from_ref_time(1_775 as u64).saturating_mul(s as u64))
	...
	fn set_validation_data() -> Weight {
		Weight::from_ref_time(50_568_000 as u64)
