...
impl<T: frame_system::Config> pallet_bridge_transfer::WeightInfo for WeightInfo<T> {
	...
	/// Storage: unknown `0x36e13a2aa5713f59bab8576f408dc957` (r:1 w:0)
	/// Proof Skipped: unknown `0x36e13a2aa5713f59bab8576f408dc957` (r:1 w:0)
	...
	fn transfer_asset_via_bridge() -> Weight {
		...
		//  Measured:  `554`
		//  Estimated: `6196`
		// Minimum execution time: 137_104_000 picoseconds.
		Weight::from_parts(156_534_000, 0)
