...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		Weight::from_ref_time(14_433_000 as RefTimeWeight)
			...
			.saturating_add((3_315_000 as RefTimeWeight).saturating_mul(c as RefTimeWeight))
	}
	...
	fn batch_all(c: u32, ) -> Weight {
		Weight::from_ref_time(16_023_000 as RefTimeWeight)
			// Standard Error: 2_000
			.saturating_add((3_466_000 as RefTimeWeight).saturating_mul(c as RefTimeWeight))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		Weight::from_ref_time(16_094_000 as RefTimeWeight)
			// Standard Error: 2_000
			.saturating_add((3_280_000 as RefTimeWeight).saturating_mul(c as RefTimeWeight))
	}
}
