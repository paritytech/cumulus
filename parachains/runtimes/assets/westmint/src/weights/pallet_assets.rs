...
impl<T: frame_system::Config> pallet_assets::WeightInfo for WeightInfo<T> {
	...
	fn create() -> Weight {
		Weight::from_ref_time(30_355_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Assets Asset (r:1 w:1)
	fn force_create() -> Weight {
		Weight::from_ref_time(17_597_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Assets Asset (r:1 w:1)
	...
	fn destroy(c: u32, s: u32, a: u32, ) -> Weight {
		Weight::from_ref_time(0 as u64)
			...
			.saturating_add(Weight::from_ref_time(17_518_000 as u64).saturating_mul(c as u64))
			// Standard Error: 57_000
			.saturating_add(Weight::from_ref_time(17_769_000 as u64).saturating_mul(s as u64))
			// Standard Error: 575_000
			.saturating_add(Weight::from_ref_time(17_469_000 as u64).saturating_mul(a as u64))
	...
	// Storage: Assets Account (r:1 w:1)
	fn burn() -> Weight {
		Weight::from_ref_time(39_951_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: Assets Asset (r:1 w:1)
	...
	fn transfer() -> Weight {
		Weight::from_ref_time(53_272_000 as u64)
	...
	fn transfer_keep_alive() -> Weight {
		Weight::from_ref_time(46_168_000 as u64)
			.saturating_add(T::DbWeight::get().reads(4 as u64))
			.saturating_add(T::DbWeight::get().writes(4 as u64))
	}
	// Storage: Assets Asset (r:1 w:1)
	...
	fn force_transfer() -> Weight {
		Weight::from_ref_time(51_826_000 as u64)
			.saturating_add(T::DbWeight::get().reads(4 as u64))
			.saturating_add(T::DbWeight::get().writes(4 as u64))
	}
	...
	// Storage: Assets Account (r:1 w:1)
	fn freeze() -> Weight {
		Weight::from_ref_time(26_476_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Assets Asset (r:1 w:0)
	...
	fn transfer_ownership() -> Weight {
		Weight::from_ref_time(25_450_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Assets Asset (r:1 w:1)
	fn set_team() -> Weight {
		Weight::from_ref_time(24_068_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Assets Asset (r:1 w:0)
	...
	fn clear_metadata() -> Weight {
		Weight::from_ref_time(40_190_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Assets Asset (r:1 w:0)
	...
	fn force_clear_metadata() -> Weight {
		Weight::from_ref_time(39_844_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Assets Asset (r:1 w:1)
	...
	fn transfer_approved() -> Weight {
		Weight::from_ref_time(68_423_000 as u64)
			.saturating_add(T::DbWeight::get().reads(5 as u64))
