...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn remark_with_event(b: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 6_811 nanoseconds.
		Weight::from_ref_time(6_905_000)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 0
	...
	fn set_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(1_800_000)
			...
			.saturating_add(Weight::from_ref_time(584_136).saturating_mul(i.into()))
	...
	fn kill_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(1_790_000)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 785
			.saturating_add(Weight::from_ref_time(448_383).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
	}
	/// Storage: Skipped Metadata (r:0 w:0)
	/// Proof Skipped: Skipped Metadata (max_values: None, max_size: None, mode: Measured)
	...
	fn kill_prefix(p: u32, ) -> Weight {
		...
		Weight::from_ref_time(3_522_000)
			...
			// Standard Error: 924
			.saturating_add(Weight::from_ref_time(990_589).saturating_mul(p.into()))
