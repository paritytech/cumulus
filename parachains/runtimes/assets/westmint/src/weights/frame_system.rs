...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn remark(b: u32, ) -> Weight {
		...
		Weight::from_ref_time(1_501_000)
	...
	fn remark_with_event(b: u32, ) -> Weight {
		...
		Weight::from_ref_time(6_658_000)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 1
			.saturating_add(Weight::from_ref_time(2_166).saturating_mul(b.into()))
	}
	...
	fn set_heap_pages() -> Weight {
		...
		Weight::from_ref_time(3_516_000)
	...
	fn set_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(1_571_000)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 2_039
			.saturating_add(Weight::from_ref_time(656_862).saturating_mul(i.into()))
	...
	fn kill_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(1_601_000)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 890
			.saturating_add(Weight::from_ref_time(526_848).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
	}
	/// Storage: Skipped Metadata (r:0 w:0)
	/// Proof Skipped: Skipped Metadata (max_values: None, max_size: None, mode: Measured)
	...
	fn kill_prefix(p: u32, ) -> Weight {
		...
		Weight::from_ref_time(3_488_000)
			...
			.saturating_add(Weight::from_ref_time(1_170_318).saturating_mul(p.into()))
