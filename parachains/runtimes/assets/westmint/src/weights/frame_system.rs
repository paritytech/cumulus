...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn remark(b: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 1_327 nanoseconds.
		Weight::from_ref_time(1_436_000)
	...
	fn remark_with_event(b: u32, ) -> Weight {
		...
		Weight::from_ref_time(13_879_489)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 1
			.saturating_add(Weight::from_ref_time(2_105).saturating_mul(b.into()))
	}
	...
	fn set_heap_pages() -> Weight {
		...
		Weight::from_ref_time(3_481_000)
	...
	fn set_storage(i: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 1_405 nanoseconds.
		Weight::from_ref_time(1_542_000)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 2_111
			.saturating_add(Weight::from_ref_time(653_342).saturating_mul(i.into()))
	...
	fn kill_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(1_561_000)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 906
			.saturating_add(Weight::from_ref_time(521_031).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
	}
	/// Storage: Skipped Metadata (r:0 w:0)
	/// Proof Skipped: Skipped Metadata (max_values: None, max_size: None, mode: Measured)
	...
	fn kill_prefix(p: u32, ) -> Weight {
		...
		Weight::from_ref_time(3_306_000)
			...
			.saturating_add(Weight::from_ref_time(1_162_617).saturating_mul(p.into()))
