...
impl<T: frame_system::Config> pallet_bridge_transfer::WeightInfo for WeightInfo<T> {
	...
	/// Storage: unknown `0x732f1cab5e78eadace5c4f5d259acee9` (r:1 w:0)
	/// Proof Skipped: unknown `0x732f1cab5e78eadace5c4f5d259acee9` (r:1 w:0)
	...
	fn transfer_asset_via_bridge() -> Weight {
		...
		//  Measured:  `520`
		//  Estimated: `6196`
		// Minimum execution time: 125_083_000 picoseconds.
		Weight::from_parts(143_807_000, 0)
