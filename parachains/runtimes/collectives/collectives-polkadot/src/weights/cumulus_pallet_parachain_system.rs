...
// --output=parachains/runtimes/collectives/collectives-polkadot/src
...
impl<T: frame_system::Config> cumulus_pallet_parachain_system::WeightInfo for WeightInfo<T> {
	...
	fn authorize_upgrade() -> Weight {
		Weight::from_ref_time(34_914_000 as u64)
	...
	fn sudo_send_upward_message(l: u32, ) -> Weight {
		Weight::from_ref_time(12_843_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(4_831 as u64).saturating_mul(l as u64))
	...
	fn enact_authorized_upgrade(s: u32, ) -> Weight {
		Weight::from_ref_time(51_331_000 as u64)
			// Standard Error: 4
			.saturating_add(Weight::from_ref_time(1_849 as u64).saturating_mul(s as u64))
	...
	fn set_validation_data() -> Weight {
		Weight::from_ref_time(48_874_000 as u64)
