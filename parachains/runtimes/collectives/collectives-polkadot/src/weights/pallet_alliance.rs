...
impl<T: frame_system::Config> pallet_alliance::WeightInfo for WeightInfo<T> {
	...
	fn propose_proposed(_b: u32, _x: u32, _y: u32, p: u32, ) -> Weight {
		Weight::from_ref_time(53_023_000 as RefTimeWeight)
			...
			.saturating_add((132_000 as RefTimeWeight).saturating_mul(p as RefTimeWeight))
	...
	fn vote(x: u32, y: u32, ) -> Weight {
		Weight::from_ref_time(33_003_000 as RefTimeWeight)
			...
			.saturating_add((312_000 as RefTimeWeight).saturating_mul(x as RefTimeWeight))
			// Standard Error: 4_000
			.saturating_add((82_000 as RefTimeWeight).saturating_mul(y as RefTimeWeight))
	...
	fn veto(p: u32, ) -> Weight {
		Weight::from_ref_time(27_289_000 as RefTimeWeight)
			...
			.saturating_add((131_000 as RefTimeWeight).saturating_mul(p as RefTimeWeight))
			.saturating_add(T::DbWeight::get().reads(3 as RefTimeWeight))
	...
	fn close_early_disapproved(x: u32, y: u32, p: u32, ) -> Weight {
		Weight::from_ref_time(31_884_000 as RefTimeWeight)
			...
			.saturating_add((358_000 as RefTimeWeight).saturating_mul(x as RefTimeWeight))
			// Standard Error: 3_000
			.saturating_add((109_000 as RefTimeWeight).saturating_mul(y as RefTimeWeight))
			// Standard Error: 2_000
			.saturating_add((109_000 as RefTimeWeight).saturating_mul(p as RefTimeWeight))
			.saturating_add(T::DbWeight::get().reads(4 as RefTimeWeight))
			.saturating_add(T::DbWeight::get().writes(3 as RefTimeWeight))
	}
	// Storage: Alliance Members (r:1 w:0)
	...
	fn close_early_approved(b: u32, x: u32, y: u32, p: u32, ) -> Weight {
		Weight::from_ref_time(43_205_000 as RefTimeWeight)
			// Standard Error: 0
			.saturating_add((2_000 as RefTimeWeight).saturating_mul(b as RefTimeWeight))
			// Standard Error: 73_000
			.saturating_add((123_000 as RefTimeWeight).saturating_mul(x as RefTimeWeight))
			// Standard Error: 2_000
			.saturating_add((91_000 as RefTimeWeight).saturating_mul(y as RefTimeWeight))
			// Standard Error: 2_000
			.saturating_add((114_000 as RefTimeWeight).saturating_mul(p as RefTimeWeight))
	...
	fn close_disapproved(x: u32, y: u32, p: u32, ) -> Weight {
		Weight::from_ref_time(49_769_000 as RefTimeWeight)
			...
			.saturating_add((352_000 as RefTimeWeight).saturating_mul(x as RefTimeWeight))
			// Standard Error: 2_000
			.saturating_add((81_000 as RefTimeWeight).saturating_mul(y as RefTimeWeight))
			// Standard Error: 2_000
			.saturating_add((100_000 as RefTimeWeight).saturating_mul(p as RefTimeWeight))
	...
	fn close_approved(b: u32, _x: u32, y: u32, p: u32, ) -> Weight {
		Weight::from_ref_time(40_901_000 as RefTimeWeight)
			// Standard Error: 0
			.saturating_add((3_000 as RefTimeWeight).saturating_mul(b as RefTimeWeight))
			// Standard Error: 2_000
			.saturating_add((79_000 as RefTimeWeight).saturating_mul(y as RefTimeWeight))
			// Standard Error: 2_000
			.saturating_add((102_000 as RefTimeWeight).saturating_mul(p as RefTimeWeight))
			.saturating_add(T::DbWeight::get().reads(5 as RefTimeWeight))
			.saturating_add(T::DbWeight::get().writes(3 as RefTimeWeight))
	}
	...
	fn init_members(_x: u32, y: u32, z: u32, ) -> Weight {
		Weight::from_ref_time(39_647_000 as RefTimeWeight)
			// Standard Error: 2_000
			.saturating_add((123_000 as RefTimeWeight).saturating_mul(y as RefTimeWeight))
			// Standard Error: 2_000
			.saturating_add((116_000 as RefTimeWeight).saturating_mul(z as RefTimeWeight))
			.saturating_add(T::DbWeight::get().reads(4 as RefTimeWeight))
			.saturating_add(T::DbWeight::get().writes(4 as RefTimeWeight))
	}
	// Storage: Alliance Rule (r:0 w:1)
	...
	fn add_unscrupulous_items(n: u32, l: u32, ) -> Weight {
		Weight::from_ref_time(0 as RefTimeWeight)
			// Standard Error: 2_000
			.saturating_add((1_300_000 as RefTimeWeight).saturating_mul(n as RefTimeWeight))
			// Standard Error: 1_000
			.saturating_add((125_000 as RefTimeWeight).saturating_mul(l as RefTimeWeight))
	...
	fn remove_unscrupulous_items(n: u32, l: u32, ) -> Weight {
		Weight::from_ref_time(0 as RefTimeWeight)
			...
			.saturating_add((34_156_000 as RefTimeWeight).saturating_mul(n as RefTimeWeight))
			// Standard Error: 87_000
			.saturating_add((7_042_000 as RefTimeWeight).saturating_mul(l as RefTimeWeight))
			.saturating_add(T::DbWeight::get().reads(2 as RefTimeWeight))
			.saturating_add(T::DbWeight::get().writes(2 as RefTimeWeight))
	}
}
