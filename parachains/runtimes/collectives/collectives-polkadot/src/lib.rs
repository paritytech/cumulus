...
use frame_support::{
	...
	parameter_types,
	traits::{ConstU16, ConstU32, ConstU64, ConstU8, EitherOf, EitherOfDiverse, InstanceFilter},
...
parameter_types! {
	...
	// The Alliance pallet account, used as a temporarily place to deposit a slashed imbalance before teleport to the treasury.
