...
//! EXECUTION: Some(Native), WASM-EXECUTION: Compiled, CHAIN: Some("bridge-hub-rococo-dev"), DB CACHE: 1024
...
impl<T: frame_system::Config> cumulus_pallet_xcmp_queue::WeightInfo for WeightInfo<T> {
	...
	fn enqueue_xcmp_messages(n: u32, ) -> Weight {
		...
		Weight::from_parts(3_384_000, 0)
			...
			.saturating_add(Weight::from_parts(963_177, 0).saturating_mul(n.into()))
