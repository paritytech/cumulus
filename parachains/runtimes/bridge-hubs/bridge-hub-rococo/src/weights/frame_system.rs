...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn remark(b: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 1_254 nanoseconds.
		Weight::from_ref_time(1_343_000)
	...
	fn remark_with_event(b: u32, ) -> Weight {
		...
		Weight::from_ref_time(158_708_651)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 4
			.saturating_add(Weight::from_ref_time(1_890).saturating_mul(b.into()))
	}
	...
	fn set_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(1_530_000)
			...
			.saturating_add(Weight::from_ref_time(647_430).saturating_mul(i.into()))
	...
	fn kill_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(1_465_000)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 872
			.saturating_add(Weight::from_ref_time(518_638).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
	}
	/// Storage: Skipped Metadata (r:0 w:0)
	/// Proof Skipped: Skipped Metadata (max_values: None, max_size: None, mode: Measured)
	...
	fn kill_prefix(p: u32, ) -> Weight {
		...
		Weight::from_ref_time(3_172_000)
			...
			.saturating_add(Weight::from_ref_time(1_160_785).saturating_mul(p.into()))
