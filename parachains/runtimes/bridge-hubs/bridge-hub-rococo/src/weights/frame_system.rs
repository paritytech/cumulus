...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn remark_with_event(b: u32, ) -> Weight {
		...
		Weight::from_ref_time(20_882_173)
			// Standard Error: 5
			.saturating_add(Weight::from_ref_time(2_081).saturating_mul(b.into()))
	}
	...
	fn set_heap_pages() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `495`
		// Minimum execution time: 2_995 nanoseconds.
		Weight::from_parts(3_356_000, 495)
	...
	fn set_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(1_593_000)
			...
			.saturating_add(Weight::from_ref_time(627_521).saturating_mul(i.into()))
	...
	fn kill_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(1_601_000)
			// Standard Error: 768
			.saturating_add(Weight::from_ref_time(507_369).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
	}
	/// Storage: Skipped Metadata (r:0 w:0)
	/// Proof Skipped: Skipped Metadata (max_values: None, max_size: None, mode: Measured)
	...
	fn kill_prefix(p: u32, ) -> Weight {
		...
		//  Measured:  `68 + p * (69 ±0)`
		//  Estimated: `66 + p * (70 ±0)`
		// Minimum execution time: 3_151 nanoseconds.
		Weight::from_parts(3_287_000, 66)
			// Standard Error: 1_725
			.saturating_add(Weight::from_ref_time(1_144_476).saturating_mul(p.into()))
