...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(7_375_466)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 963
			.saturating_add(Weight::from_ref_time(4_492_354).saturating_mul(c.into()))
	}
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(10_505_166)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 1_112
			.saturating_add(Weight::from_ref_time(4_734_062).saturating_mul(c.into()))
	}
	fn dispatch_as() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 7_973 nanoseconds.
	...
	fn force_batch(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(8_781_801)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 822
			.saturating_add(Weight::from_ref_time(4_497_627).saturating_mul(c.into()))
	}
}
