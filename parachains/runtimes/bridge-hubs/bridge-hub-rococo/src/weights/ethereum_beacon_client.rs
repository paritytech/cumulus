...
// --pallet=ethereum_beacon_client
// --extrinsic=*
// --steps=50
// --repeat=20
// --json
// --header=./file_header.txt
// --output=./parachains/runtimes/bridge-hubs/bridge-hub-rococo/src/weights/ethereum_beacon_client.rs
...
impl<T: frame_system::Config> ethereum_beacon_client::WeightInfo for WeightInfo<T> {
	...
	fn sync_committee_period_update() -> Weight {
		...
		//  Measured:  `1911`
		//  Estimated: `19205`
		// Minimum execution time: 50_725_674 nanoseconds.
		Weight::from_parts(50_798_621_000, 19205)
	...
	fn import_finalized_header() -> Weight {
		...
		//  Measured:  `1911`
		//  Estimated: `14634`
		// Minimum execution time: 50_628_636 nanoseconds.
		Weight::from_parts(50_708_235_000, 14634)
	...
	/// Proof: EthereumBeaconClient ExecutionHeaders (max_values: None, max_size: Some(599), added: 3074, mode: MaxEncodedLen)
	fn import_execution_header() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1991`
		//  Estimated: `8748`
		// Minimum execution time: 50_666_519 nanoseconds.
		Weight::from_parts(50_754_135_000, 8748)
			.saturating_add(T::DbWeight::get().reads(6))
