...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn remark_with_event(b: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 6_508 nanoseconds.
		Weight::from_ref_time(6_730_000)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 0
	...
	fn set_heap_pages() -> Weight {
		...
		Weight::from_ref_time(3_575_000)
	...
	fn set_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(1_824_000)
			...
			.saturating_add(Weight::from_ref_time(562_597).saturating_mul(i.into()))
	...
	fn kill_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(1_681_000)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 821
			.saturating_add(Weight::from_ref_time(430_273).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
	}
	/// Storage: Skipped Metadata (r:0 w:0)
	/// Proof Skipped: Skipped Metadata (max_values: None, max_size: None, mode: Measured)
	...
	fn kill_prefix(p: u32, ) -> Weight {
		...
		Weight::from_ref_time(3_488_000)
			.saturating_add(Weight::from_proof_size(66))
			// Standard Error: 1_178
			.saturating_add(Weight::from_ref_time(967_305).saturating_mul(p.into()))
