...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn remark(b: u32, ) -> Weight {
		...
		Weight::from_ref_time(6_250_688)
	...
	fn set_heap_pages() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `495`
		// Minimum execution time: 3_673 nanoseconds.
	...
	fn set_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(1_852_000)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 1_997
			.saturating_add(Weight::from_ref_time(558_035).saturating_mul(i.into()))
	...
	fn kill_storage(i: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 1_787 nanoseconds.
		Weight::from_ref_time(1_828_000)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 786
			.saturating_add(Weight::from_ref_time(429_318).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
	}
	/// Storage: Skipped Metadata (r:0 w:0)
	/// Proof Skipped: Skipped Metadata (max_values: None, max_size: None, mode: Measured)
	...
	fn kill_prefix(p: u32, ) -> Weight {
		...
		//  Measured:  `68 + p * (69 ±0)`
		//  Estimated: `66 + p * (70 ±0)`
		// Minimum execution time: 3_672 nanoseconds.
		Weight::from_ref_time(3_747_000)
			.saturating_add(Weight::from_proof_size(66))
			// Standard Error: 1_237
			.saturating_add(Weight::from_ref_time(972_339).saturating_mul(p.into()))
