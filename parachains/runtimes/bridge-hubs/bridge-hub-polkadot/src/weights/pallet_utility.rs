...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(9_176_464)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 1_425
			.saturating_add(Weight::from_ref_time(4_325_392).saturating_mul(c.into()))
	}
	fn as_derivative() -> Weight {
		...
		Weight::from_ref_time(4_231_000)
			.saturating_add(Weight::from_proof_size(0))
	}
	/// The range of component `c` is `[0, 1000]`.
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(13_196_600)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 2_159
			.saturating_add(Weight::from_ref_time(4_516_885).saturating_mul(c.into()))
	}
	fn dispatch_as() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 7_657 nanoseconds.
		Weight::from_ref_time(7_968_000)
			.saturating_add(Weight::from_proof_size(0))
	}
	/// The range of component `c` is `[0, 1000]`.
	fn force_batch(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(12_163_065)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 1_764
			.saturating_add(Weight::from_ref_time(4_329_007).saturating_mul(c.into()))
	}
}
