...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn remark(b: u32, ) -> Weight {
		...
		Weight::from_ref_time(19_405_156)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 0
			.saturating_add(Weight::from_ref_time(404).saturating_mul(b.into()))
	}
	/// The range of component `b` is `[0, 3932160]`.
	...
	fn set_storage(i: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 3_037 nanoseconds.
		Weight::from_ref_time(3_071_000)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 2_090
			.saturating_add(Weight::from_ref_time(562_675).saturating_mul(i.into()))
	...
	fn kill_storage(i: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 1_764 nanoseconds.
		Weight::from_ref_time(1_818_000)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 827
			.saturating_add(Weight::from_ref_time(437_898).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
	}
	/// Storage: Skipped Metadata (r:0 w:0)
	/// Proof Skipped: Skipped Metadata (max_values: None, max_size: None, mode: Measured)
	...
	fn kill_prefix(p: u32, ) -> Weight {
		...
		//  Measured:  `68 + p * (69 ±0)`
		//  Estimated: `66 + p * (70 ±0)`
		// Minimum execution time: 5_941 nanoseconds.
		Weight::from_ref_time(6_043_000)
			.saturating_add(Weight::from_proof_size(66))
			// Standard Error: 1_167
			.saturating_add(Weight::from_ref_time(967_402).saturating_mul(p.into()))
