...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn remark(b: u32, ) -> Weight {
		...
		Weight::from_ref_time(1_755_000)
	...
	fn set_heap_pages() -> Weight {
		...
		Weight::from_ref_time(3_739_000)
	...
	fn set_storage(i: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 1_617 nanoseconds.
		Weight::from_ref_time(1_669_000)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 1_856
			.saturating_add(Weight::from_ref_time(554_633).saturating_mul(i.into()))
	...
	fn kill_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(1_830_000)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 861
			.saturating_add(Weight::from_ref_time(430_380).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
	}
	/// Storage: Skipped Metadata (r:0 w:0)
	/// Proof Skipped: Skipped Metadata (max_values: None, max_size: None, mode: Measured)
	...
	fn kill_prefix(p: u32, ) -> Weight {
		...
		Weight::from_ref_time(4_832_000)
			.saturating_add(Weight::from_proof_size(66))
			// Standard Error: 1_168
			.saturating_add(Weight::from_ref_time(966_863).saturating_mul(p.into()))
