...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 6_298 nanoseconds.
		Weight::from_ref_time(19_277_184)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 2_183
			.saturating_add(Weight::from_ref_time(3_736_122).saturating_mul(c.into()))
	}
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(26_002_314)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 2_257
			.saturating_add(Weight::from_ref_time(3_943_508).saturating_mul(c.into()))
	}
	fn dispatch_as() -> Weight {
		...
		Weight::from_ref_time(8_024_000)
			.saturating_add(Weight::from_proof_size(0))
	}
	/// The range of component `c` is `[0, 1000]`.
	fn force_batch(c: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 6_117 nanoseconds.
		Weight::from_ref_time(12_624_215)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 1_912
			.saturating_add(Weight::from_ref_time(3_746_093).saturating_mul(c.into()))
	}
}
