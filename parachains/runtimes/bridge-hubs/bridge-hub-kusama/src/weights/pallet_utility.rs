...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 6_047 nanoseconds.
		Weight::from_ref_time(12_945_956)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 2_093
			.saturating_add(Weight::from_ref_time(3_921_088).saturating_mul(c.into()))
	}
	fn as_derivative() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 4_366 nanoseconds.
		Weight::from_ref_time(4_520_000)
			.saturating_add(Weight::from_proof_size(0))
	}
	/// The range of component `c` is `[0, 1000]`.
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(21_764_393)
			.saturating_add(Weight::from_proof_size(0))
			// Standard Error: 7_276
			.saturating_add(Weight::from_ref_time(4_113_995).saturating_mul(c.into()))
	}
	fn dispatch_as() -> Weight {
		...
		Weight::from_ref_time(8_176_000)
			.saturating_add(Weight::from_proof_size(0))
	}
	/// The range of component `c` is `[0, 1000]`.
	fn force_batch(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(9_952_000)
			...
			.saturating_add(Weight::from_ref_time(4_020_228).saturating_mul(c.into()))
	}
}
