...
//! # Bridge Transfer Pallet for on-chain configuration management
//!
//! ## Overview
//!
...
pub const LOG_TARGET: &str = "runtime::bridge-transfer::config";
...
pub mod pallet {
	...
	use crate::types::{
		...
		BridgeConfig, LatestVersionedMultiLocation, UsingVersioned,
	};
