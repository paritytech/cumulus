...
benchmarks! {
	...
	note_author {
		...
		let new_block: frame_system::BlockNumberOf<T> = 10u32.into();
	...
	new_session {
		...
		let new_block: frame_system::BlockNumberOf<T> = 1800u32.into();
		let zero_block: frame_system::BlockNumberOf<T> = 0u32.into();
