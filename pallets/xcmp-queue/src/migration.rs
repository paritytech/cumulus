...
pub fn migrate_to_latest<T: Config>() -> Weight {
	let mut weight = /* TODO: hack: Weight::zero()*/ 0_u64;
...
mod tests {
	...
	fn test_migration_to_v1() {
		let v0 = v0::QueueConfigData {
			...
			drop_threshold: 12,
			resume_threshold: 3,
			threshold_weight: /* TODO: hack: Weight::from_ref_time*/(333_333),
			weight_restrict_decay: /* TODO: hack: Weight::from_ref_time*/(1),
		};
		...
		new_test_ext().execute_with(|| {
			...
			assert_eq!(v1.xcmp_max_individual_weight, /* TODO: hack: Weight::from_ref_time*/(20_000_000_000));
		});
	}
}
