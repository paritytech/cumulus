...
use crate::chain_spec::{
	get_account_id_from_seed, Extensions,
};
...
fn glutton_genesis(parachain_id: ParaId) -> glutton_runtime::GenesisConfig {
	glutton_runtime::GenesisConfig {
		...
		glutton: glutton_runtime::GluttonConfig { compute: Default::default(), storage: Default::default(), trash_data_count: Default::default() },
