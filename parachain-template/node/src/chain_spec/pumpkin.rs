...
pub fn pumpkin_config() -> Result<ChainSpec, String> {
	ChainSpec::from_json_bytes(&include_bytes!("../../../../resources/pumpkin-dist.json")[..])
}
pub fn latest_pumpkin_config() -> ChainSpec {
