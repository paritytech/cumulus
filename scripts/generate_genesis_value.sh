...
chain_id=$1
rpc_endpoint=$2
work_dir="parachain-runtimes/chain-specs"
...
if [[ "$rpc_endpoint" =~ "localhost" ]]; then
    ...
    echo -e "target/release/polkadot-parachain --chain parachain-runtimes/chain-specs/shell-statemint.json --tmp\n"
...
ls -al parachain-runtimes/chain-specs/${chain_id}_value*.*
