...
chain_id=$1
rpc_endpoint=$2
work_dir="polkadot-parachains/chain-specs"
...
if [[ "$rpc_endpoint" =~ "localhost" ]]; then
    ...
    echo -e "target/release/polkadot-parachain --chain polkadot-parachains/chain-specs/shell-statemint.json --tmp\n"
...
ls -al polkadot-parachains/chain-specs/${chain_id}_value*.*
