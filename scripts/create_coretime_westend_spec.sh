...
usage() {
    ...
    echo "$2 <para_id>"
    echo "e.g.: ./scripts/create_coretime_westend_spec.sh ./target/release/wbuild/coretime-westend-runtime/coretime_westend_runtime.compact.compressed.wasm 1005"
    exit 1
}
...
binary="./target/release/westend-parachain"
...
cp chain-spec-raw.json ./parachains/chain-specs/coretime-westend.json
